...
Presentation/demo scenes can reuse the same prefabs with `DesktopDebugUi` and `DesktopCameraController`. Do not mix demo time-scale scrubbing into evaluation logs. See [UI_DEBUG.md](UI_DEBUG.md).
