...
4. Open **Test Runner → EditMode** and run all `EvoLife.Tests.EditMode` tests.
...
8. Optional: start Backend and toggle `StatsExportLoop.uploadToBackend` once a collector is wired in the scene.
